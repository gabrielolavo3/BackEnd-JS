...
const { signupSchema, signinSchema, acceptdCodeSchema, changePasswordSchema } = require('../middlewares/validator');
const userModel = require('../models/userModel');
const { doHash, doHashValidation, hmacProcess } = require('../utils/hasting');
...
exports.signup = async (req, res) => {
    ...
    try {
        const { error, value } = await signupSchema.validateAsync({ email, password });
...
exports.signin = async (req, res) => {
    ...
    try {
        const { error, value } = signinSchema.validateAsync ({ email, password });
...
exports.verifyVerificationCode = async (req, res) => {
    ...
    try {
        const { error, value } = await acceptdCodeSchema.validateAsync ({ email, providedCode });
...
exports.changePassword = async (req, res) => {
    ...
    try {
        const { error, value } = await changePasswordSchema.validateAsync ({ oldPassword, newPassword });
